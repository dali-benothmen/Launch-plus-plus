...
- [x] **P1-06 — Build the authenticated application shell.** Implement the global icon rail, Home project explorer, route boundaries, and required unavailable/forbidden/error states.
- [x] **P1-06a — Build Home.** Add first-project guidance, quick access, pinned projects, one-level folders, project context actions, and the all-projects table. Keep analytics and configurable dashboard widgets outside core.
