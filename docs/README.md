...
| UI information architecture | Accepted for iteration | Global icon rail, contextual sidebar, one-level project folders, shared project views, route-backed task detail, and scoped Settings |
