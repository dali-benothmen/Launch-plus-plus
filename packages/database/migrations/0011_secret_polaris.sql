...
CREATE UNIQUE INDEX `teams_organization_id_unique` ON `teams` (`organization_id`,`id`);--> statement-breakpoint
...
INSERT INTO `__new_tasks`("id", "organization_id", "project_id", "number", "parent_task_id", "status_id", "team_id", "title", "description_markdown", "due_date", "priority", "position", "created_by_user_id", "updated_by_user_id", "created_at", "updated_at", "archived_at", "deleted_at", "revision") SELECT "id", "organization_id", "project_id", "number", "parent_task_id", "status_id", NULL, "title", "description_markdown", "due_date", 'medium', "position", "created_by_user_id", "updated_by_user_id", "created_at", "updated_at", "archived_at", "deleted_at", "revision" FROM `tasks`;--> statement-breakpoint
